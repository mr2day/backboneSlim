...
class NotORM_Result extends NotORM_Abstract implements Iterator, ArrayAccess, Countable {
	...
	protected function query($query, $parameters) {
		...
		if (! $return || ! $return->execute ( array_map ( array (
				$this,
				'formatValue' 
		), $parameters ) )) {
			return false;
	 ...
	 * 
	 * @param
	 *        	mixed array($column => $value)|Traversable for single row insert or NotORM_Result|string for INSERT ... SELECT
	 * @param
	 *        	... used for extended insert
	 ...
	 *        	array ($column => $value)
	 * @param
	 *        	array ($column => $value), empty array means use $insert
	 * @return int number of affected rows or false in case of an error
	 */
	 ...
	 * 
	 * @param
	 *        	string condition possibly containing ? or :name
	 * @param
	 *        	mixed array accepted by PDOStatement::execute or a scalar value
	 * @param
	 *        	mixed ...
	 * @return NotORM_Result fluent interface
	 */
	 ...
	 *        	string
	 * @param
	 *        	string column name used for an array value or an empty string for the whole row
	 * @return array
	 */
	 ...
	 * 
	 * @param
	 *        	string row ID or array for where conditions
	 * @return bool
	 */
