...
class NotORM_Structure_Convention implements NotORM_Structure {
	 ...
	 * 
	 * @param
	 *        	string %s stands for table name
	 * @param
	 *        	string %1$s stands for key used after ->, %2$s for table name
	 * @param
	 *        	string %1$s stands for key used after ->, %2$s for table name
	 * @param
	 *        	string prefix for all tables
	 */
...
class NotORM_Structure_Discovery implements NotORM_Structure {
	 ...
	 *        	NotORM_Cache
	 * @param
	 *        	string use "%s_id" to access $name . "_id" column in $row->$name
	 */
