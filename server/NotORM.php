...
class NotORM extends NotORM_Abstract {
	 ...
	 *        	PDO
	 * @param
	 *        	NotORM_Structure or null for new NotORM_Structure_Convention
	 * @param
	 *        	NotORM_Cache or null for no cache
	 */
	 ...
	 *        	string
	 * @param
	 *        	array (["condition"[, array("value")]]) passed to NotORM_Result::where()
	 * @return NotORM_Result
	 */
